    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map((c, i) => (
            <Link to={"isMiniGame" in c && c.isMiniGame ? "/mini-game" : "isMushroom" in c && c.isMushroom ? "/mushroom-game" : "/practice"} key={c.id} className="group relative bg-card border-2 border-border rounded-2xl p-6 hover:border-primary hover:shadow-elev hover:-translate-y-1 transition-all animate-scale-in" style={{ animationDelay: `${i * 50}ms` }}>
